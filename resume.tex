...
\resumeSubheading
      {Mid-Level Frontend Engineer}{Jun 2025 -- Present}
      {Almusand Alraqmi}{Madinah, Saudi Arabia}
      \resumeItemListStart
        \resumeItem{Contributed to the development of a delivery web application for transporting heavy machinery.}
        \resumeItem{Implemented a real-time notification system to improve communication between users, drivers, and admins.}
        \resumeItem{Collaborated on building scalable features that enhanced overall user experience and operational efficiency.}
        \resumeItem{Developed and optimized an e-commerce platform, focusing on performance and scalability.}
        \resumeItem{Increased homepage performance score from 69\% to 90\% by implementing SSR/CSR strategies, improving CLS, and applying image optimization techniques (lazy loading, responsive images).}
        \resumeItem{developed an admin dashboard for managing products, brands, and categories, enabling seamless content and inventory management.}
        \resumeItem{Developed core e-commerce features including a shopping cart and coupon/discount system, designed to enhance user engagement and checkout experience.}
      \resumeItemListEnd
    
    % ---------------------------------
    \resumeSubheading
      {Frontend Engineer}{Feb 2025 -- Jul 2025}
